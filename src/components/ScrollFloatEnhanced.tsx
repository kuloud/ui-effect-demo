...
//           ...seg,
//           content:
//             seg.type === "text" && seg.isWhitespace ? "\u00A0" : seg.content,
//         })),
//       );
//     }
...
//       const { type, props } =
//         node as React.ReactElement<React.PropsWithChildren>;
...
//       const selector =
//         splitMode === "line" ? ".scroll-float-line" : ".scroll-float-unit";
...
//     >
//       <div className={`${textClassName}`}>{renderContent()}</div>
//     </div>
//   );
// };

// // 专门的适配组件，针对您的具体格式
// export const BentoScrollFloat: React.FC<
//   Omit<ScrollFloatEnhancedProps, "splitMode">
// > = (props) => {
//   return (
//     <ScrollFloatEnhanced
